    ...
    <nav class="container mx-auto px-6 py-3 flex justify-between items-center max-w-screen-xl">
        ...
        <div class="desktop-menu flex items-center space-x-8 max-md:hidden">
            ...
            <div class="ml-4 border-l border-gray-300/50 dark:border-gray-600 pl-4 flex items-center space-x-4">
                <button id="lang-toggle-desktop" aria-label="Cambiar idioma" class="flex items-center text-white dark:text-gray-200 hover:text-brand-medium dark:hover:text-brand-medium transition-colors duration-200"></button>
                
                <button id="theme-toggle" type="button" aria-label="Cambiar tema de color" class="text-white dark:text-gray-400 hover:bg-white/20 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-brand-light dark:focus:ring-gray-700 rounded-lg text-sm p-2.5">
        ...
        <div class="md:hidden flex items-center">
             ...
             <button id="theme-toggle-mobile" type="button" aria-label="Cambiar tema de color" class="text-white dark:text-gray-400 hover:bg-white/20 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-brand-light dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 mr-2">
