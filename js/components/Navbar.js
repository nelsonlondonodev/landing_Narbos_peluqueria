...
export function getNavbarHTML(basePath = './', isHome = true) {
    ...
    const navLink = (href, key, text, mobile = false) => {
        const baseClasses = "text-white dark:text-brand-light hover:text-brand-medium dark:hover:text-brand-medium active:text-brand-medium dark:active:text-brand-medium";
        const mobileClasses = "block py-2 px-4 text-lg hover:bg-brand-light/20 dark:hover:bg-brand-green/30 rounded-md active:bg-brand-light/40 dark:active:bg-brand-green/50";
    ...
    <nav class="container mx-auto px-6 py-3 flex justify-between items-center max-w-screen-xl">
        ...
        <div class="desktop-menu flex items-center space-x-8 max-md:hidden">
            ...
            <div class="relative group">
                <button id="desktop-services-btn" class="flex items-center text-white dark:text-brand-light hover:text-brand-medium dark:hover:text-brand-medium transition-colors py-2 focus:outline-none" aria-haspopup="true" aria-expanded="false">
                ...
                <div id="desktop-services-menu" class="absolute left-0 top-full pt-2 w-48 hidden group-hover:block hover:block z-50">
                    <div class="bg-white dark:bg-brand-gray-dark rounded-md shadow-xl py-2 border border-brand-medium/20 dark:border-brand-medium/20">
                        <a href="${basePath}servicios/peluqueria.html" class="block px-4 py-2 text-sm text-brand-gray-dark dark:text-brand-light hover:bg-brand-light/20 dark:hover:bg-brand-green/30 hover:text-brand-green dark:hover:text-brand-medium transition-colors">Peluquería</a>
            ...
            <a href="${basePath}blog/index.html" class="text-white dark:text-brand-light hover:text-brand-medium dark:hover:text-brand-medium active:text-brand-medium dark:active:text-brand-medium">Blog</a>

            <div class="ml-4 border-l border-brand-medium/50 dark:border-brand-medium/50 pl-4 flex items-center space-x-4">
                <button id="lang-toggle-desktop" aria-label="Cambiar idioma" class="flex items-center text-white dark:text-brand-light hover:text-brand-medium dark:hover:text-brand-medium transition-colors duration-200"></button>
                
                <button id="theme-toggle" type="button" aria-label="Cambiar tema de color" class="text-white dark:text-brand-light hover:bg-white/20 dark:hover:bg-brand-green/30 focus:outline-none focus:ring-4 focus:ring-brand-light dark:focus:ring-brand-green/50 rounded-lg text-sm p-2.5">
        ...
        <div class="md:hidden flex items-center">
             <button id="lang-toggle-mobile" aria-label="Cambiar idioma" class="mr-2 flex items-center text-white hover:text-white dark:hover:text-brand-medium transition-colors duration-200"></button>
             <button id="theme-toggle-mobile" type="button" aria-label="Cambiar tema de color" class="text-white dark:text-brand-light hover:bg-white/20 dark:hover:bg-brand-green/30 focus:outline-none focus:ring-4 focus:ring-brand-light dark:focus:ring-brand-green/50 rounded-lg text-sm p-2.5 mr-2">
             ...
             <button id="menu-btn" aria-label="Abrir menú de navegación" class="text-white dark:text-brand-light focus:outline-none z-50">
    ...
    <div id="mobile-menu" class="md:hidden fixed top-0 right-0 h-screen w-64 bg-white dark:bg-brand-gray-dark text-brand-gray-dark dark:text-brand-light shadow-2xl z-[110] transform translate-x-full transition-transform duration-300 ease-in-out">
        <div class="flex justify-end p-4">
            <button id="internal-close-btn" aria-label="Cerrar menú" class="p-2 text-brand-gray-dark/80 hover:text-brand-gray-dark dark:text-brand-light/80 dark:hover:text-brand-light transition-colors">
