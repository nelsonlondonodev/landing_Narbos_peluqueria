            ...
            <div class="relative group">
                ...
                <div id="desktop-services-menu" class="absolute left-0 top-full pt-2 w-56 hidden group-hover:block hover:block z-50">
                    <div class="bg-white rounded-md shadow-xl py-2 border border-brand-medium/20 text-left">
                        ...
                        <a href="${basePath}servicios/estetica/spa-facial-integral.html" class="block px-4 py-2 text-sm text-brand-gray-dark hover:bg-brand-light/20 hover:text-brand-green transition-colors" data-i18n="services.spa">Spa y Estética</a>
    ...
    <div id="mobile-menu" class="md:hidden fixed top-0 right-0 w-64 h-[100dvh] bg-white text-brand-gray-dark shadow-2xl z-[110] transform translate-x-full transition-transform duration-300 ease-in-out">
        ...
        <div class="flex flex-col px-8 space-y-4 overflow-y-auto max-h-[calc(100dvh-80px)]">
            ...
            <div class="border-b border-gray-100 pb-2">
                ...
                <a href="${basePath}servicios/unas-spa/unas-acrilicas-gel-chia.html" class="block py-2 px-6 text-lg hover:bg-brand-light/10 text-brand-gray-dark" data-i18n="services.nails">Uñas</a>
                <a href="${basePath}servicios/estetica/spa-facial-integral.html" class="block py-2 px-6 text-lg hover:bg-brand-light/10 text-brand-gray-dark" data-i18n="services.spa">Spa</a>
